    ...
    return (
      <div className="min-h-screen bg-gray-50 flex justify-center items-center pt-20">
        <div className="text-center">
          <h2 className="text-2xl font-bold mb-2">Failed to load fleet data</h2>
    ...
    <div className="min-h-screen bg-gray-50 pt-20">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          {isLoading ? (
            <div className="max-w-5xl mx-auto p-8 border rounded-lg animate-pulse bg-white">
              <div className="h-12 mb-8 bg-gray-200 rounded w-full"></div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 mb-4">
                          ...
                          <span>Capacity: {bus.capacity} passengers</span>
                        </div>
            ...
            <div className="text-center py-8 border rounded-md bg-gray-50 max-w-5xl mx-auto">
        ...
        <div className="container mx-auto px-4">
          ...
          {isLoading ? (
            <div className="overflow-x-auto">
              <div className="w-full bg-white rounded-lg shadow-md animate-pulse p-4">
              ...
              <table className="w-full bg-white rounded-lg shadow-md">
                <thead>
                  <tr>
                    ...
                    {fleet.map((bus) => (
                      <th key={bus.id} className="py-4 px-6 text-center">{bus.name}</th>
                    ))}
                  </tr>
                </thead>
                <tbody>
                  ...
                  <tr className="bg-gray-100">
                    ...
                    {fleet.map((bus) => (
                      <td key={`${bus.id}-price`} className="py-4 px-6 text-center">
